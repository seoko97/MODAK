...
export const APIURL = `http://api.visitkorea.or.kr/openapi/service/rest/GoCamping/basedList?APIURL=${process.env.SERVICE_KEY}&pageNo=1&numOfRows=3000&MobileOS=ETC&MobileApp=AppTest&_type=json`;
